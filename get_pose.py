...
os.system("time python2.7 features_3Dpoints_builder.py "+data_dir+"/model_images_database image_retrieval_result_for_"+query_image_arg_no_ext+".txt " + query_image_arg_no_ext)
print "Running script 4/5"
os.system("time python2.7 query_matcher.py "+data_dir+"/query_images_databases/database_for_"+query_image_arg_no_ext+".db "+data_dir+" " + query_image_arg_no_ext)
if(run_soft_posit == '1'):
