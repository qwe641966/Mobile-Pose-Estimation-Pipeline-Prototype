...
all_3d_points_dm = importdata('results/arcore640/3D_points_direct.txt');
all_3d_points_image_retrieval = importdata('results/arcore640/3D_points_image_retrieval.txt');

% ARCore mobile phone pose
ar_core_pose = importdata('data/home_small_boxes/ar_core_poses/pose.txt')';
...
pose_img_retrieval = importdata('results/arcore640/RT_image_retrieval.txt');
...
% Direct Matching:
pose_direct_matching = importdata('results/arcore640/RT_direct_matching.txt');
...
% 3D point in ARCore
ar_core_3D_points = inv(ar_core_pose) * [[camera_R_img_retrieval camera_T_img_retrieval] ; 0 0 0 1] * all_3d_points_image_retrieval';
